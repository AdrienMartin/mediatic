...
public class MediaDAO extends GenericDAO<Media>{
	...
	public List<Media>recherche(String titre, String auteur, String typeMedia, int typeTrie){
		...
		TypedQuery<Media> q = em.createQuery("Select m From media_ m where m.titre=:%titre% and a.auteur=%:auteur% or a.typeMedia=:typeMedia order by :trie :desc ",Media.class);
